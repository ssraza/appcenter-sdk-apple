...
- (void)testFlushQueueWithAuthTokenHistory {

  // 1. New auth token
  // 2. Enqueue two logs
  // 3. New auth token
  // 4. Enqueue three logs
  // 5. Sign out
  // 6. Enqueue one log
}

- (void)testFlushQueueWithAuthTokenHistoryFillsGap {

  // 0 sec: New auth token expires after 1 sec
  // 0.5 sec: Enqueue two logs
  // 1.5 sec: Enqueue one log
  // 2 sec: New auth token expires after 1 sec
  // 3.5 sec: Enqueue three logs
}
