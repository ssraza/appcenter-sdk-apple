...
// TODO: Implement this one. Add one more test that has gaps between tokens. The gaps should be filled by anonymous automatically.
// Remove getValidMockLogArrayForDate and getValidMockLogWithDate if not necessary.
